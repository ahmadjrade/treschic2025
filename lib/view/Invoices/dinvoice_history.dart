...
class DInvoiceHistory extends StatelessWidget {
  DInvoiceHistory({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    invoiceHistoryController.CalTotalDelivery();
                ...
                child: Obx(
                  () {
                    final List<InvoiceModel> filteredinvoices =
                        invoiceHistoryController.SearchDInvoices(
                      FilterQuery.text,
                    );
