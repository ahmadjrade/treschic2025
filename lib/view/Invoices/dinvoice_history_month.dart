...
class DInvoiceHistoryMonth extends StatelessWidget {
  DInvoiceHistoryMonth({super.key});
  ...
  Widget build(BuildContext context) {
    invoiceHistoryController.CalTotalMonthDelivery();
                ...
                child: Obx(
                  () {
                    final List<InvoiceModel> filteredinvoices =
                        invoiceHistoryController.SearchDInvoicesMonth(
                      FilterQuery.text,
                    );
