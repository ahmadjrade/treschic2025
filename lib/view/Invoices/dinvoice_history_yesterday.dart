...
class DInvoiceHistoryYesterday extends StatelessWidget {
  DInvoiceHistoryYesterday({super.key});
  ...
  Widget build(BuildContext context) {
    invoiceHistoryController.CalTotalYdayDelivery();
                ...
                child: Obx(
                  () {
                    final List<InvoiceModel> filteredinvoices =
                        invoiceHistoryController.SearchDInvoicesYesterday(
                      FilterQuery.text,
                    );
