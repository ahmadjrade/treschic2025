...
import 'package:treschic/view/Invoices/invoice_sold_all.dart';
import 'package:treschic/view/Invoices/invoice_sold_month.dart';
import 'package:treschic/view/Invoices/invoice_sold_today.dart';
import 'package:treschic/view/Invoices/invoice_sold_yesterday.dart';
import 'package:treschic/view/Invoices/invoice_today_items.dart';
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: TabBarView(
            children: [
              InvoiceSoldToday(), // Page for "Today" tab
              InvoiceSoldYday(),
              InvoiceSoldMonth(), // Page for "Yesterday" tab
              // Page for "Yesterday" tab
              InvoiceSoldAll(), // Page for "All" tab
            ],
          ),
        ),
      ),
