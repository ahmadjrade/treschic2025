...
class InvoiceSoldMonth extends StatelessWidget {
  InvoiceSoldMonth({super.key});
  ...
  Widget build(BuildContext context) {
    invoiceDetailController.CalTotalMonth();
  ...
  body: SafeArea(
    child: Column(
      ...
      children: [
        ...
        Expanded(
          child: Obx(() {
            final List<InvoiceHistoryModel> filteredInvoices = invoiceDetailController.SearchInvoicesMonth(
              FilterQuery.text,
            );
            if (invoiceDetailController.isLoading.value) {
              ...
              return Center(child: Text('No Items Sold Yet In This Store!'));
            } else {
              return ListView.builder(
                itemCount: filteredInvoices.length,
                itemBuilder: (context, index) {
                  final InvoiceHistoryModel invoice = filteredInvoices[index];
                  return Card(
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(width: 5),
                              Text('Product Color: ${invoice.Product_Color}'),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Text('Unit Price: ${invoice.product_UP}\$'),
                                  SizedBox(height: 5),
                                  Text(' | Total Price: ${invoice.product_TP}\$'),
                                ],
                              ),
                              SizedBox(height: 25),
                            ],
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Obx(() => Text(
                        '${addCommasToNumber(invoiceDetailController.total_month.value)}\$',
