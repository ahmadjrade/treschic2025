...
class InvoiceTodayItems extends StatefulWidget {
  InvoiceTodayItems({
    super.key,
  });

  @override
  State<InvoiceTodayItems> createState() => _InvoiceHistoryItemsState();
}

class _InvoiceHistoryItemsState extends State<InvoiceTodayItems> {
  ...
  Widget build(BuildContext context) {
    ...
    List<InvoiceHistoryModel> filteredProductDetails() {
      ...
      String formattedTime = dateController.getFormattedTime();
      final filterText = filter.value.toLowerCase();
      return invoiceDetailController.invoice_detail
          .where((invoice_detail) =>
              invoice_detail.Invoice_Date == formattedDate &&
              invoice_detail.Username == Username.value &&
              ...
              child: Obx(
                () {
                  ...
                  if (invoiceDetailController.isLoading.value) {
                    ...
                    return Center(child: Text('No Items Sold Today !'));
                  } else {
                          ...
                          child: ExpansionTile(
                            ...
                            trailing: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'TP: ' + invoice.product_TP.toString() + '\$',
                                  style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      fontSize: 12,
