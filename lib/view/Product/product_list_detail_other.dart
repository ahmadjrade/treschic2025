...
class ProductListDetailOther extends StatelessWidget {
  String Product_id,
      Product_Name,
      Product_LPrice,
      Product_MPrice,
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Card(
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  //       if (isPur == '1') {
                                  //         invoiceController
                                  //             .fetchProduct(product.pdetail_code);
                                  //       } else if (isPur == '3') {
                                  //         transferController
                                  //             .fetchProduct(product.pdetail_code);
                                  //       } else {
                            ...
                            // backgroundColor: Colors.green.shade900.shade100,
                            ...
                            //               Get.to(() => ProductListDetailOther e(Product_id: product.Product_id.toString(), Product_Name: product.Product_Name,Product_Color: product.Product_Color,));
                            //   },
                            //   child: Text('Select')),
