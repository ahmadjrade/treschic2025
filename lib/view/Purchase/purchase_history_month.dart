...
class PurchaseHistoryMonth extends StatelessWidget {
  PurchaseHistoryMonth({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    purchaseHistoryController.CalTotalMonth();
                ...
                child: Obx(
                  () {
                    final List<PurchaseModel> filteredinvoices =
                        purchaseHistoryController.SearchPurchasesMonth(
                      FilterQuery.text,
                    );
