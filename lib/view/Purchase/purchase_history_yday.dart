...
class PurchaseHistoryYesterday extends StatelessWidget {
  PurchaseHistoryYesterday({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    purchaseHistoryController.CalTotalYday();
                ...
                child: Obx(
                  () {
                    final List<PurchaseModel> filteredinvoices =
                        purchaseHistoryController.SearchPurchasesYesterday(
                      FilterQuery.text,
                    );
