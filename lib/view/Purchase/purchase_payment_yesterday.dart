...
class PurchasePaymentYesterday extends StatelessWidget {
  PurchasePaymentYesterday({super.key});
  ...
  Widget build(BuildContext context) {
    purchasePaymentController.CalTotalYday();
                  ...
                  Obx(
                    () {
                      final List<PurchasePaymentModel> filteredinvoices =
                          purchasePaymentController.SearchInvoicesYesterday(
                        FilterQuery.text,
                      );
