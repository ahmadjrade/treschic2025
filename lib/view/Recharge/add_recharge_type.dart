...
class AddRechargeType extends StatelessWidget {
 AddRechargeType({super.key,});

  TextEditingController Type_Name = TextEditingController();
  
  final InsertRechargeType insertRechargeType =
      Get.put(InsertRechargeType());

        final CartTypesController cartTypesController = Get.find<CartTypesController>();
...
SizedBox(height: 20,),
            ...
            OutlinedButton(
                  ...
                  onPressed: () {
                      ...
                      insertRechargeType.UploadCard(
                              Type_Name.text
                             
                             )
                          .then((value) =>
                              showToast(insertRechargeType.result))
                          .then((value) =>
