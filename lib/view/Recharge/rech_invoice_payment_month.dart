...
class RechInvoicePaymentMonth extends StatelessWidget {
  RechInvoicePaymentMonth({super.key});
  ...
  Widget build(BuildContext context) {
    rechInvoicePaymentController.CalTotalMonth();
                  ...
                  Obx(
                    () {
                      final List<RechInvoicePaymentModel> filteredinvoices =
                          rechInvoicePaymentController.SearchInvoicesMonth(
                        FilterQuery.text,
                      );
