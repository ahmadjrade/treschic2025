...
class RechargeInvoiceHistoryMonth extends StatelessWidget {
  RechargeInvoiceHistoryMonth({super.key});
  ...
  Widget build(BuildContext context) {
    rechargeInvoiceHistoryController.CalTotalMonth();
                  ...
                  Obx(
                    () {
                      final List<InvoiceModel> filteredinvoices =
                          rechargeInvoiceHistoryController.SearchRechargeMonth(
                        FilterQuery.text,
                      );
