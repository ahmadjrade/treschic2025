                                                ...
                                                Expanded(
                                                  child: OutlinedButton(
                                                      ...
                                                      style: ElevatedButton
                                                        ...
                                                        backgroundColor: repairsController.getcolor(repair.Repair_Status),
                                                        shape:
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          Text(
                                                            'Select',
                                                            style: TextStyle(
                                                                color: repairsController.getcolor2(repair.Repair_Status)),
                                                          ),
                                                          SizedBox(
                                                            width: 5,
                                                          ),
                                                          Icon(
                                                            ...
                                                            color: repairsController.status(
                                                                    repair
                                                                        .Repair_Status)
                                                                ? repairsController.getcolor2(repair.Repair_Status)
                                                                : repairsController.getcolor2(repair.Repair_Status),
                                                            //  'Details',
                                                            //   style: TextStyle(
                                                            //        color: Colors.red),
