...
class FinishedRepairs extends StatelessWidget {
  FinishedRepairs({super.key});
          ...
          children: [
            ...
            Expanded(child: Obx(() {
              final List<RepairsModel> filteredrepairs =
                  repairsController.searchFinishedRepairs(
                FilterQuery.text,
              );
              if (repairsController.isLoading.value) {
                return Center(child: CircularProgressIndicator());
              } else if (repairsController.repair.isEmpty) {
                return Center(child: Text('No Repairs Yet In This Store ! '));
                                                                      ...
                                                                      Expanded(
                                                                        child: OutlinedButton(
                                                                            ...
                                                                            onPressed: () {
                                                                              ...
                                                                              repairsController.UpdateRepair(repair.Repair_id.toString(), 'Delivered').then((value) => Navigator.of(context).pop()).then((value) => Navigator.of(context).pop()).then((value) => showToast(repairsController.Update_result)).then((value) => repairsController.isDataFetched = false).then((value) => repairsController.fetchrepairs());
                                                                              // Navigator.of(context).pop();
                                                                            },
                                                                            child: Text(
                                                                              'Yes',
