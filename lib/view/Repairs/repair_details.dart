        ...
        child: Column(
          children: [
            ...
            OutlinedButton(
                ...
                onPressed: () {
                  Get.to(() => AddRepairItems(Rep_id: widget.Repair_id));
                        ...
                        return Container(
                          ...
                          child: ExpansionTile(
                            ...
                            trailing: Column(
                              ...
                              children: [
                                Text(
                                  repair.RProduct_Qty.toString() + ' PCS',
                                  style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      fontSize: 12),
                                ),
                                Text(
                                  'UP: ' + repair.product_UP.toString() + '\$',
                                  style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      fontSize: 12,
                            ...
                            title: Text(
                              '#' +
                                  repair.Repair_detail_id.toString() +
                                  ' || ' +
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    // checkPhone(repair.isPhone)
                                    //     ? Text('Phone id: ' +
                                    //         repair.Phone_id.toString())
                                    //     : Text('Product id: ' +
                                    //         repair.Product_id.toString()),
