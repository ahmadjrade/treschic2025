...
class TransferHistoryAll extends StatelessWidget {
  TransferHistoryAll({super.key});
  ...
  Widget build(BuildContext context) {
    // transferHistoryController.CalTotalall();
            ...
            children: [
              Column(
                children: [
                  ...
                  Obx(
                    () {
                      final List<TransferHistoryModel> filteredinvoices =
                          transferHistoryController
                              .searchTransferAll(FilterQuery.text);
                          ...
                          children: [
                            ListView.builder(
                              ...
                              itemCount: filteredinvoices.length <
                                  ...
                                  : transferHistoryController.itemsToShow.value,
                            ...
                            if (transferHistoryController.itemsToShow.value <
                                filteredinvoices.length)
                              Padding(
                                padding: const EdgeInsets.symmetric(
                                    horizontal: 120.0),
