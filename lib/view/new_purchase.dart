                        ...
                        InputDecorator(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              var product =
                                  purchaseController.purchaseItems[index];
                              return Card(
                                  child: Padding(
                                                            ...
                                                            TextButton(
                                                              onPressed: () {
                                                                if (New_Price
                                                                        .text !=
                                                                    '') {
                                                                  purchaseController.updateItemPrice(
                                                                      purchaseController
                                                                              .purchaseItems[
                                                                          index],
                                                                      double.tryParse(
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            IconButton(
                                                onPressed: () {
                                                  if (product.quantity.value ==
                                                    ...
                                                    purchaseController.DecreaseQty(
                                                        purchaseController
                                                                .purchaseItems[
                                                            index]);
                                                  }
                                            ...
                                            IconButton(
                                                onPressed: () {
                                                  purchaseController.IncreaseQty(
                                                      purchaseController
                                                              .purchaseItems[
                                                          index]);
                                                },
